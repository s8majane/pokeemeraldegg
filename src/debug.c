...
static void DebugAction_Get_Mega(u8);
static void DebugAction_Cancel(u8);
static void DebugTask_HandleMainMenuInput(u8);

static const u8 gDebugText_Get_Mega[] = _("Get Mega");
static const u8 gDebugText_Cancel[] = _("Cancel");

enum {
    DEBUG_MENU_ITEM_GET_MEGA,
    DEBUG_MENU_ITEM_CANCEL,
};

static const struct ListMenuItem sDebugMenuItems[] =
{
    [DEBUG_MENU_ITEM_GET_MEGA] = {gDebugText_Get_Mega, DEBUG_MENU_ITEM_GET_MEGA},
    [DEBUG_MENU_ITEM_CANCEL] = {gDebugText_Cancel, DEBUG_MENU_ITEM_CANCEL},
};

static void (*const sDebugMenuActions[])(u8) =
{
    [DEBUG_MENU_ITEM_GET_MEGA] = DebugAction_Get_Mega,
...
static void DebugAction_Get_Mega(u8 taskId)
{
    AddBagItem(ITEM_MEGA_BRACELET, 1);
    ScriptGiveMon(SPECIES_KANGASKHAN, 20, ITEM_KANGASKHANITE, 0, 0, 0);
    Debug_DestroyMainMenu(taskId);
}
